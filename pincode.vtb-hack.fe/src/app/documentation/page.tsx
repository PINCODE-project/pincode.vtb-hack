	...
	return (
		<div className={`rounded-xl border-2 p-4 ${getLevelGradient(level)}`}>
			...
			<div className="space-y-3 mb-4">
				{metric && (
					<div className="flex items-center gap-2">
						<span className="text-sm font-medium text-gray-700">Метрика:</span>
				...
				{threshold && (
					<div className="flex items-center gap-2">
						<span className="text-sm font-medium text-gray-700">Пороговое значение:</span>
			...
			<div className="space-y-2">
				<h4 className="text-sm font-semibold text-gray-900 flex items-center gap-2">Рекомендации</h4>
				<ul className="space-y-2">
					{recommendations.map((rec, index) => (
						<li key={index} className="flex items-center gap-2 text-sm text-gray-600 mb-1">
							<div className="w-0.5 h-0.5 rounded-full bg-gray-400 flex-shrink-0"></div>
				...
				<div className="max-w-4xl mx-auto p-8">
					<div className="mb-20">
						...
						<p className="text-muted-foreground">
							На этой странице собраны все правила анализа и рекомендации, применяемые алгоритмическим
							модулем сервиса. Здесь вы можете ознакомиться с логикой, по которой формируются выводы
							системы, а также с набором методик и практик, лежащих в основе автоматизированного анализа
						</p>
					</div>
