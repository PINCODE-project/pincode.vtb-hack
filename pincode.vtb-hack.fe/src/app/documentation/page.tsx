...
function TableOfContents({ items, title = "Оглавление", className, ...props }: TableOfContentsProps) {
	return (
		<CollapsiblePrimitive.Root
			{...props}
			className={cn("not-prose rounded-lg border bg-card text-card-foreground", className)}
		>
