...
import type { Geometry } from "./utils.ts";
import { calculatePosition, makeMiddleTicksGeometry, makeSlitTicksGeometry } from "./utils.ts";
...
export function UnavailableTicks({ theme, geometry, tickWidth, minValue, maxValue, className }: TicksProps) {
