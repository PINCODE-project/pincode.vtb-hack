...
import { timeZoneControl } from "../../../../../../../../../../../Downloads/date-components-main/src/demo/utils/zones.ts";
import { RelativeRangeDatePicker } from "../../../../../../../../../../../Downloads/date-components-main/src/components/RelativeRangeDatePicker";
import type { RelativeRangeDatePickerValue } from "../../../../../../../../../../../Downloads/date-components-main/src/components/RelativeRangeDatePicker";
import { RangeDateSelection } from "../RangeDateSelection.tsx";
import type { ViewportDimensions, ViewportInterval } from "../components/Ruler/Ruler.tsx";
...
export const Default = {
	render: (args) => {
		...
		const props = {
			...
			placeholderValue: args.placeholderValue ? dateTimeParse(args.placeholderValue, { timeZone }) : undefined,
...
export const WithControls = {
	...
	render: function WithControls(args) {
		...
		const placeholderValue = args.placeholderValue ? dateTimeParse(args.placeholderValue, { timeZone }) : undefined;
			...
			<div>
				...
				>
					...
					<div style={{ display: "flex", gap: "2px" }}>
						<Button view="flat" onClick={() => setValue(getRelativeInterval("now - 30m", "now"))}>
							30m
						</Button>
						<Button view="flat" onClick={() => setValue(getRelativeInterval("now - 1h", "now"))}>
							1h
						</Button>
						<Button view="flat" onClick={() => setValue(getRelativeInterval("now - 1d", "now"))}>
							1d
						</Button>
						<Button view="flat" onClick={() => setValue(getRelativeInterval("now - 1w", "now"))}>
							1w
						</Button>
					</div>
				</div>
...
function renderAdditionalRulerContent(props: { interval: ViewportInterval; dimensions: ViewportDimensions }) {
